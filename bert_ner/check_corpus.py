...
def check_corpus():
    file_list = [u'./resources/corpus_20001-25000.csv']
    f_error = codecs.open(u'./resources/error_entities.txt', u'w', 'utf-8')
...
if __name__ == '__main__':
    ...
    # generate_dataset(u'./resources/test.csv', u'./resources/test.txt')
    # generate_dataset(u'./resources/validate.csv', u'./resources/validate.txt')
    ...
    generate_dataset(u'./resources/corpus_20001-25000.csv', u'./resources/corpus_20001-25000.txt')
